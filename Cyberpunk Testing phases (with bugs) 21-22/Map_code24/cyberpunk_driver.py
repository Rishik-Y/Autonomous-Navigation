        ...
        if critical_vehicle:
            ...
            if dot_heading < -0.8:
                ...
                if my_car.id > critical_vehicle.id:
                    ...
                    # I Bully (Ignore this car and maintain speed)
                    # We continue to Proportional Factor logic? 
                    # No, if we bully, we expect THEM to stop/reverse.
                    # If we brake, we defeat the purpose of bullying.
