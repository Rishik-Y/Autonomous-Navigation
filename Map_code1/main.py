...
def run_simulation():
    ...
    while running:
        ...
        if direction == 0 and car.op_timer <= 0: # Time to get a new path
            ...
            # This logic block runs once when loading/unloading is finished
            ...
            if route_nodes:
                ...
                # What to do here? For now, just wait.
                pass
        ...
        if direction != 0:
            ...
            v_stop_cap = math.sqrt(2 * MAX_BRAKE_DECEL * max(0, dist_to_target - 2.0)) # Start braking 2m before end
